...
class PortfolioOptimizer:
    ...
    def optimize_portfolio_weights(self, expected_returns, covariance_matrix, risk_free_rate=0.001):
    ...
    def create_optimal_portfolio(self, symbols, lookback_months=12):
        ...
        for symbol in symbols:
            try:
                ...
                print(f"  年率ボラティリティ: {performance['annual_volatility']*100:.1f}%")
        ...
        portfolio_volatility = np.sqrt(np.dot(optimal_weights.T, np.dot(covariance_matrix.values, optimal_weights)))
...
def main():
    ...
    if portfolio_result:
        ...
        if backtest_result:
            ...
            print(f"実績ベース年間収益予測: {1000000 * backtest_result['annualized_return']:,.0f}円")
