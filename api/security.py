...
try:
    ...
    logger.warning("config/secrets.py not found, using environment variables or defaults")
    if 'change-me' in str(API_KEYS):
        logger.error("SECURITY WARNING: Using default API keys! Set CLSTOCK_DEV_KEY and CLSTOCK_ADMIN_KEY environment variables")
