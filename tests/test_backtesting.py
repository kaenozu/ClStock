...
class TestBacktestEngine(unittest.TestCase):
    ...
    def test_sell_stock(self):
        ...
        expected_capital = self.test_initial_capital - (buy_price * buy_quantity) + (sell_price * sell_quantity)
    ...
    def test_calculate_metrics(self):
        ...
        self.engine.transaction_history = [
            {'symbol': '000001', 'action': 'BUY', 'quantity': 10, 'price': 1000, 'total_cost': 10000},
            {'symbol': '000001', 'action': 'SELL', 'quantity': 5, 'price': 1100, 'revenue': 5500},
            {'symbol': '000001', 'action': 'SELL', 'quantity': 5, 'price': 900, 'revenue': 4500}
        ]
