...
# AdvancedCacheManagerは統合されました
from models_refactored.core.interfaces import PredictionResult as TickData, DataProvider as OrderBookData
...
class TestRealTimeCacheManager:
    ...
    def test_cache_order_book_data(self, sample_order_book_data):
        ...
        assert cache.order_book_cache[sample_order_book_data.symbol][0]["data"] == sample_order_book_data
