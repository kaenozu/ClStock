...
class DynamicRiskManager:
    ...
    def should_reduce_position(self, symbol: str, current_price: float) -> bool:
        ...
        # リスク閾値を超えていたら縮小を検討
        if (
            metrics.var_95 < self.risk_thresholds["var_95"]
            or metrics.var_99 < self.risk_thresholds["var_99"]
            or metrics.max_drawdown < self.risk_thresholds["max_drawdown"]
        ):
            return True
    ...
    def calculate_optimal_position_size(
        ...
        max_position_size = (
            max_position_value / current_price if current_price > 0 else 0
        )
