...
class TestEnsembleStockPredictor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.predictor = EnsembleStockPredictor(data_provider=self.mock_data_provider)
    ...
    @patch('models_new.ensemble.ensemble_predictor.EnsembleStockPredictor.predict_score')
    ...
    def test_get_model_info(self):
        ...
        self.assertEqual(info['name'], 'EnsembleStockPredictor')
    ...
    @patch('models_new.ensemble.ensemble_predictor.joblib.dump')
    ...
    @patch('models_new.ensemble.ensemble_predictor.joblib.load')
