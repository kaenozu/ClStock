...
_spec = importlib.machinery.PathFinder.find_spec("lightgbm", _search_paths)
...
if _spec and _spec.loader:
    ...
    class Booster:  # pragma: no cover - placeholder type
        def __init__(self, *_, **__):
            raise RuntimeError("LightGBM is unavailable in this test environment")

    class Dataset:  # pragma: no cover - placeholder type
        def __init__(self, *_, **__):
            raise RuntimeError("LightGBM is unavailable in this test environment")
