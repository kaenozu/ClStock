...
def test_rate_limiting():
    ...
    if not rate_limit_hit:
        print("ℹ Rate limit not triggered (may need more requests or different configuration)")
...
def test_context_managers():
    ...
    try:
        ...
        with managed_resource(create_dummy_resource, cleanup_dummy_resource) as resource:
