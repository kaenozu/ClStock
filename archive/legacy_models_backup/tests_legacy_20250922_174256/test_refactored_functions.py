...
class TestRefactoredFunctions:
    ...
    def test_format_basic_prediction_result(self, capsys):
        ...
        symbol = "7203"
        result = {"direction": 1, "confidence": 0.85, "predicted_price": 10000}
    ...
    def test_execute_integrated_analysis(self):
        ...
        with patch("clstock_main.TrendFollowingPredictor") as mock_trend_class, patch(
            "clstock_main.MarketSentimentAnalyzer"
        ) as mock_sentiment_class:
            ...
            mock_sentiment_instance.analyze_news_sentiment.assert_called_once_with(
                "8306"
            )
